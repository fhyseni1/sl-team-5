...
namespace UserHealthService.Infrastructure.Migrations
{
    ...
    [Migration("20251030110506_AddAppointmentReport")]
    partial class AddAppointmentReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserHealthService.Domain.Entities.AppointmentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserHealthService.Domain.Entities.DoctorAssistant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UserHealthService.Domain.Entities.AppointmentReport", b =>
                {
                    b.HasOne("UserHealthService.Domain.Entities.Appointment", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserHealthService.Domain.Entities.Doctor", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("UserHealthService.Domain.Entities.DoctorAssistant", b =>
                {
                    b.HasOne("UserHealthService.Domain.Entities.User", "Assistant")
                        .WithMany()
                        .HasForeignKey("AssistantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserHealthService.Domain.Entities.User", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
